export const Iscas = {
    ...
    <main class="conteudo">
        ...
        <div v-for="metodo in metodos" class="cartao_img">
            <img :src="'/FormigueiroVirtual/img/iscas/'+metodo.img" @click="expandirImg(metodo.img)">
    ...
    data(){
        return{
            metodos: [
                {img:'formigueiro.jpg',title:'Coleta Manual/Buscativa',text:'Coletar formigas que estão na parte de fora do formigueiro ou distantes, como em pedras, troncos de árvores, dentro de casa, etc.'},
