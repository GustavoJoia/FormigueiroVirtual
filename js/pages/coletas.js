    ...
    methods:{
        expandirImg(img){
            this.locais.forEach(local => {
                if(local.img==img){
                    Swal.fire({
                        html:'<div style="display: flex; flex-direction: column; justify-content: center; align-items: center;"><img style="width: 90%; height: 80%; object-fit: fill" src="/FormigueiroVirtual/img/locais/'+local.img+'"><p>'+local.legenda+'</p></div>',
